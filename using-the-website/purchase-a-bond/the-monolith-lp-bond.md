...
2. Head to the [Monolith LP Bond page of the EXODUS website](https://app.exodia.fi/bonds/the\_monolith\_lp). There are two tabs: "Bond" and "Redeem". Make sure "Bond" is selected.
...
4. If this is your first purchase, you need to approve the EXODUS contract to spend your BPT-MNLT tokens. Click "Approve" and sign the transaction.
